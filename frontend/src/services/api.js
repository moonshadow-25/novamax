...
export const comfyuiService = {
  ...
  deleteModelFile: (modelId, type, filename) => api.delete(`/comfyui/${modelId}/delete-model`, { data: { type, filename } }),
...
export const ttsService = {
  ...
  deleteFile: (modelId, filename) => api.delete(`/tts/models/${modelId}/files/${encodeURIComponent(filename)}`),
...
export const ocrModelsService = {
  ...
  deleteFile: (modelId, filename) => api.delete(`/ocr-models/models/${modelId}/files/${encodeURIComponent(filename)}`),
...
export const asrModelsService = {
  ...
  deleteFile: (modelId, filename) => api.delete(`/asr-models/models/${modelId}/files/${encodeURIComponent(filename)}`),
